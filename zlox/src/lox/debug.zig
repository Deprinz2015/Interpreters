...
pub fn disassembleInstruction(chunk: *Chunk, offset: usize) usize {
    ...
    return switch (chunk.opAt(offset)) {
        ...
        .ARRAY => byteInstruction("OP_ARRAY", chunk, offset),
        ...
        .GET_ARRAY => byteInstruction("OP_GET_ARRAY", chunk, offset),
        .SET_ARRAY => byteInstruction("OP_SET_ARRAY", chunk, offset),
        .APPEND => byteInstruction("OP_APPEND", chunk, offset),
